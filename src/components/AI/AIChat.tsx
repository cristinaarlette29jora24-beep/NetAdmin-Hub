...
\`\`\``
  ...
  return `Entendido. Te respondo como simulador técnico de redes.
...
function AIChat() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Hola, soy tu asistente técnico de redes (modo simulador). Puedo responderte con guías prácticas sobre Cisco y Linux. ¿Qué problema quieres resolver?',
    },
  ])
