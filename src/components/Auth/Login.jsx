    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>NETADMIN <span style={{color: '#4ecca3'}}>HUB</span></h1>
...
const styles = {
  container: {
    ...
    alignItems: 'center',
    height: '100vh',
    backgroundColor: '#0a0f1e', // Fondo ultra oscuro
  ...
  card: {
    ...
    padding: '40px',
    borderRadius: '16px',
    boxShadow: '0 0 20px rgba(78, 204, 163, 0.2)', // Brillo sutil cian
    width: '100%',
    maxWidth: '400px',
