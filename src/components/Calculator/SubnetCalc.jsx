...
function ResultRow({ label, value }) {
  return (
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 py-3 px-4 rounded-lg"
  ...
  return (
    <div className="max-w-6xl mx-auto flex flex-col gap-6 sm:gap-8 fade-in-up">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 items-start">
        <div className="pro-card rounded-2xl p-5 sm:p-7 flex flex-col gap-5 shadow-2xl"
          style={{
